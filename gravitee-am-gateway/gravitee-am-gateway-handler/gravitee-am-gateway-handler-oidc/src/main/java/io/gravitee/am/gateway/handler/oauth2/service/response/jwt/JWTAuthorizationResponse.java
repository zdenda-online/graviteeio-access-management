...
public abstract class JWTAuthorizationResponse<T extends AuthorizationResponse> extends AuthorizationResponse {
    ...
    JWTAuthorizationResponse(T response) {
    ...
    public String buildRedirectUri(final String responseType, final String responseMode, final String token) throws URISyntaxException {
